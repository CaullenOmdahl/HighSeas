/**
 * Subtitle format converter (SRT to WebVTT)
 * Based on stremio-video-reference/src/withHTMLSubtitles/subtitlesConverter.js
 * Original source: https://github.com/silviapfeiffer/silviapfeiffer.github.io/blob/master/index.html#L150-L216
 */

function srt2webvtt(data: string): string {
    // remove dos newlines
...
export default {
    convert: function(text: string): string {
